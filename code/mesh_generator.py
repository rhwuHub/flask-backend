...
def generate_ellipse_mesh(output_filename="SqrCirc.msh"):
    ...
    factory.addPoint(Centx, Ry + Centy, 0, lc1, 5)  # 上顶点
    factory.addPoint(Rx + Centx, Centy, 0, lc1, 6)  # 右顶点
    factory.addPoint(Centx, -Ry + Centy, 0, lc1, 7)  # 下顶点
    ...
    print("Mesh generated with the following element types:")
